...
# Form implementation generated from reading ui file 'ui/datawindow.ui'
#
# Created: Sat Jun 22 16:59:47 2013
...
class Ui_DataWindow(object):
    def setupUi(self, DataWindow):
        DataWindow.setObjectName(_fromUtf8("DataWindow"))
        DataWindow.resize(429, 283)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/db.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        DataWindow.setWindowIcon(icon)
        self.verticalLayout = QtGui.QVBoxLayout(DataWindow)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.tabWidget = QtGui.QTabWidget(DataWindow)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 371, 617))
...
" }"))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 371, 624))
...
" }"))
    ...
    def retranslateUi(self, DataWindow):
        DataWindow.setWindowTitle(QtGui.QApplication.translate("DataWindow", "Data Window", None, QtGui.QApplication.UnicodeUTF8))
        self.InputElevlabel.setText(QtGui.QApplication.translate("DataWindow", "Input", None, QtGui.QApplication.UnicodeUTF8))
        self.Tilinglabel.setText(QtGui.QApplication.translate("DataWindow", "Tiling", None, QtGui.QApplication.UnicodeUTF8))
        self.Autotiling.setText(QtGui.QApplication.translate("DataWindow", "AutoTiling", None, QtGui.QApplication.UnicodeUTF8))
        self.ManualTiling.setText(QtGui.QApplication.translate("DataWindow", "ManualTiling", None, QtGui.QApplication.UnicodeUTF8))
        self.CopyElev.setText(QtGui.QApplication.translate("DataWindow", "cp", None, QtGui.QApplication.UnicodeUTF8))
        self.ExportElev.setText(QtGui.QApplication.translate("DataWindow", "Export", None, QtGui.QApplication.UnicodeUTF8))
        self.elevdir.setText(QtGui.QApplication.translate("DataWindow", "Open Dir", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("DataWindow", "Elevation", None, QtGui.QApplication.UnicodeUTF8))
        item = self.data.horizontalHeaderItem(0)
        item.setText(QtGui.QApplication.translate("DataWindow", "Raster", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("DataWindow", "name", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("DataWindow", "legend text color", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(1, QtGui.QApplication.translate("DataWindow", "red", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(2, QtGui.QApplication.translate("DataWindow", "orange", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(3, QtGui.QApplication.translate("DataWindow", "yellow", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(4, QtGui.QApplication.translate("DataWindow", "green", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(5, QtGui.QApplication.translate("DataWindow", "blue", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(6, QtGui.QApplication.translate("DataWindow", "indigo", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(7, QtGui.QApplication.translate("DataWindow", "violet", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(8, QtGui.QApplication.translate("DataWindow", "white", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(9, QtGui.QApplication.translate("DataWindow", "black", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(10, QtGui.QApplication.translate("DataWindow", "gray", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(11, QtGui.QApplication.translate("DataWindow", "brown", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(12, QtGui.QApplication.translate("DataWindow", "magenta", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(13, QtGui.QApplication.translate("DataWindow", "aqua", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(14, QtGui.QApplication.translate("DataWindow", "grey", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(15, QtGui.QApplication.translate("DataWindow", "cyan", None, QtGui.QApplication.UnicodeUTF8))
        self.textlegendcolor.setItemText(16, QtGui.QApplication.translate("DataWindow", "purple", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("DataWindow", "True-Color support", None, QtGui.QApplication.UnicodeUTF8))
        self.TrueColor.setItemText(1, QtGui.QApplication.translate("DataWindow", "TRUE", None, QtGui.QApplication.UnicodeUTF8))
        self.TrueColor.setItemText(2, QtGui.QApplication.translate("DataWindow", "FALSE", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("DataWindow", "Transparent Background", None, QtGui.QApplication.UnicodeUTF8))
        self.AlphaBkg.setItemText(1, QtGui.QApplication.translate("DataWindow", "TRUE", None, QtGui.QApplication.UnicodeUTF8))
        self.AlphaBkg.setItemText(2, QtGui.QApplication.translate("DataWindow", "FALSE", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("DataWindow", "PNG Read", None, QtGui.QApplication.UnicodeUTF8))
        self.PngRead.setItemText(1, QtGui.QApplication.translate("DataWindow", "FALSE", None, QtGui.QApplication.UnicodeUTF8))
        self.PngRead.setItemText(2, QtGui.QApplication.translate("DataWindow", "TRUE", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("DataWindow", "Background Color", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("DataWindow", "PNG Compression", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(1, QtGui.QApplication.translate("DataWindow", "1", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(2, QtGui.QApplication.translate("DataWindow", "2", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(3, QtGui.QApplication.translate("DataWindow", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(4, QtGui.QApplication.translate("DataWindow", "4", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(5, QtGui.QApplication.translate("DataWindow", "5", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(6, QtGui.QApplication.translate("DataWindow", "6", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(7, QtGui.QApplication.translate("DataWindow", "7", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(8, QtGui.QApplication.translate("DataWindow", "8", None, QtGui.QApplication.UnicodeUTF8))
        self.PngKomp.setItemText(9, QtGui.QApplication.translate("DataWindow", "9", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("DataWindow", "Height", None, QtGui.QApplication.UnicodeUTF8))
        self.height.setText(QtGui.QApplication.translate("DataWindow", "480", None, QtGui.QApplication.UnicodeUTF8))
        self.label_9.setText(QtGui.QApplication.translate("DataWindow", "Width", None, QtGui.QApplication.UnicodeUTF8))
        self.width.setText(QtGui.QApplication.translate("DataWindow", "640", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("DataWindow", "At", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_6), QtGui.QApplication.translate("DataWindow", "I/O", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("DataWindow", "Options", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("DataWindow", "Lines", None, QtGui.QApplication.UnicodeUTF8))
        self.AdvLines.setText(QtGui.QApplication.translate("DataWindow", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_13.setText(QtGui.QApplication.translate("DataWindow", "Thin", None, QtGui.QApplication.UnicodeUTF8))
        self.AdvThin.setText(QtGui.QApplication.translate("DataWindow", "1", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("DataWindow", "LabelNum", None, QtGui.QApplication.UnicodeUTF8))
        self.AdvLabelNum.setText(QtGui.QApplication.translate("DataWindow", "5", None, QtGui.QApplication.UnicodeUTF8))
        self.label_14.setText(QtGui.QApplication.translate("DataWindow", "Use", None, QtGui.QApplication.UnicodeUTF8))
        self.label_15.setText(QtGui.QApplication.translate("DataWindow", "Range", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_v.setText(QtGui.QApplication.translate("DataWindow", "Do not show category labels", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_c.setText(QtGui.QApplication.translate("DataWindow", "Do not show category numbers", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_n.setText(QtGui.QApplication.translate("DataWindow", "Skip category with no labels", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_s.setText(QtGui.QApplication.translate("DataWindow", "Draw smooth gradient", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_f.setText(QtGui.QApplication.translate("DataWindow", "Flip legend", None, QtGui.QApplication.UnicodeUTF8))
        self.placemark.setText(QtGui.QApplication.translate("DataWindow", "Placemark", None, QtGui.QApplication.UnicodeUTF8))
        self.placemarks.setItemText(0, QtGui.QApplication.translate("DataWindow", "icon", None, QtGui.QApplication.UnicodeUTF8))
        self.placemarks.setItemText(1, QtGui.QApplication.translate("DataWindow", "yellow_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.placemarks.setItemText(2, QtGui.QApplication.translate("DataWindow", "red_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.placemarks.setItemText(3, QtGui.QApplication.translate("DataWindow", "blue_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.placemarks.setItemText(4, QtGui.QApplication.translate("DataWindow", "green_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.addlegend.setText(QtGui.QApplication.translate("DataWindow", "l", None, QtGui.QApplication.UnicodeUTF8))
        self.adddescription.setText(QtGui.QApplication.translate("DataWindow", "d", None, QtGui.QApplication.UnicodeUTF8))
        self.flag_z.setText(QtGui.QApplication.translate("DataWindow", "i", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_8), QtGui.QApplication.translate("DataWindow", "Opt", None, QtGui.QApplication.UnicodeUTF8))
        self.exportoverlay.setText(QtGui.QApplication.translate("DataWindow", "Export", None, QtGui.QApplication.UnicodeUTF8))
        self.overlaydir.setText(QtGui.QApplication.translate("DataWindow", "Open Dir", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), QtGui.QApplication.translate("DataWindow", "Overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.Point.setText(QtGui.QApplication.translate("DataWindow", "Point", None, QtGui.QApplication.UnicodeUTF8))
        self.Line.setText(QtGui.QApplication.translate("DataWindow", "Line", None, QtGui.QApplication.UnicodeUTF8))
        self.Polygon.setText(QtGui.QApplication.translate("DataWindow", "Polygon", None, QtGui.QApplication.UnicodeUTF8))
        self.InputVectorlabel.setText(QtGui.QApplication.translate("DataWindow", "Input", None, QtGui.QApplication.UnicodeUTF8))
        self.KmlGeneralgroupBox.setTitle(QtGui.QApplication.translate("DataWindow", "General", None, QtGui.QApplication.UnicodeUTF8))
        self.Iconlabel.setText(QtGui.QApplication.translate("DataWindow", "Icon", None, QtGui.QApplication.UnicodeUTF8))
        self.LabelFieldlabel.setText(QtGui.QApplication.translate("DataWindow", "LabelField", None, QtGui.QApplication.UnicodeUTF8))
        self.LineWidthlabel.setText(QtGui.QApplication.translate("DataWindow", "Line Width", None, QtGui.QApplication.UnicodeUTF8))
        self.SelectIcon.setItemText(1, QtGui.QApplication.translate("DataWindow", "blue_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.SelectIcon.setItemText(2, QtGui.QApplication.translate("DataWindow", "green_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.SelectIcon.setItemText(3, QtGui.QApplication.translate("DataWindow", "red_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.SelectIcon.setItemText(4, QtGui.QApplication.translate("DataWindow", "yellow_circle", None, QtGui.QApplication.UnicodeUTF8))
        self.Tessellatelabel.setText(QtGui.QApplication.translate("DataWindow", "Tessellate", None, QtGui.QApplication.UnicodeUTF8))
        self.Extrudelabel.setText(QtGui.QApplication.translate("DataWindow", "Extrude", None, QtGui.QApplication.UnicodeUTF8))
        self.KmlElevationgroupBox.setTitle(QtGui.QApplication.translate("DataWindow", "Elevation", None, QtGui.QApplication.UnicodeUTF8))
        self.Offsetlabel.setText(QtGui.QApplication.translate("DataWindow", "OffSet", None, QtGui.QApplication.UnicodeUTF8))
        self.HeightFieldlabel.setText(QtGui.QApplication.translate("DataWindow", "HeightField", None, QtGui.QApplication.UnicodeUTF8))
        self.Heightlabel.setText(QtGui.QApplication.translate("DataWindow", "Heigth", None, QtGui.QApplication.UnicodeUTF8))
        self.ExtrudeType.setItemText(1, QtGui.QApplication.translate("DataWindow", "2D", None, QtGui.QApplication.UnicodeUTF8))
        self.ExtrudeType.setItemText(2, QtGui.QApplication.translate("DataWindow", "3D", None, QtGui.QApplication.UnicodeUTF8))
        self.ExtrudeType.setItemText(3, QtGui.QApplication.translate("DataWindow", "Offset", None, QtGui.QApplication.UnicodeUTF8))
        self.ExtrudeType.setItemText(4, QtGui.QApplication.translate("DataWindow", "Attribute", None, QtGui.QApplication.UnicodeUTF8))
        self.AltitudeModelabel.setText(QtGui.QApplication.translate("DataWindow", "Altitude   ", None, QtGui.QApplication.UnicodeUTF8))
        self.AltitudeMode.setItemText(1, QtGui.QApplication.translate("DataWindow", "clampToGround", None, QtGui.QApplication.UnicodeUTF8))
        self.AltitudeMode.setItemText(2, QtGui.QApplication.translate("DataWindow", "relativeToGround", None, QtGui.QApplication.UnicodeUTF8))
        self.AltitudeMode.setItemText(3, QtGui.QApplication.translate("DataWindow", "absolute", None, QtGui.QApplication.UnicodeUTF8))
        self.KmlColorgroupBox.setTitle(QtGui.QApplication.translate("DataWindow", "Color", None, QtGui.QApplication.UnicodeUTF8))
        self.colorModeEnum.setItemText(1, QtGui.QApplication.translate("DataWindow", "normal", None, QtGui.QApplication.UnicodeUTF8))
        self.colorModeEnum.setItemText(2, QtGui.QApplication.translate("DataWindow", "random", None, QtGui.QApplication.UnicodeUTF8))
        self.VectorPolygonColor.setText(QtGui.QApplication.translate("DataWindow", "Polygon", None, QtGui.QApplication.UnicodeUTF8))
        self.VectorLineColor.setText(QtGui.QApplication.translate("DataWindow", "Line", None, QtGui.QApplication.UnicodeUTF8))
        self.VectorLabelColor.setText(QtGui.QApplication.translate("DataWindow", "Label", None, QtGui.QApplication.UnicodeUTF8))
        self.ColorModelabel.setText(QtGui.QApplication.translate("DataWindow", "ColorMode", None, QtGui.QApplication.UnicodeUTF8))
        self.ExportVect.setText(QtGui.QApplication.translate("DataWindow", "Export", None, QtGui.QApplication.UnicodeUTF8))
        self.vectordir.setText(QtGui.QApplication.translate("DataWindow", "Open Dir", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("DataWindow", "KML", None, QtGui.QApplication.UnicodeUTF8))
