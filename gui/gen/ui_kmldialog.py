...
#
# Created: Sat Sep 14 01:31:09 2013
...
class Ui_KmlDialog(object):
    def setupUi(self, KmlDialog):
        ...
        KmlDialog.resize(562, 624)
        self.scrollArea = QtGui.QScrollArea(KmlDialog)
        self.scrollArea.setGeometry(QtCore.QRect(0, 0, 546, 587))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        self.scrollAreaWidgetContents = QtGui.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 528, 642))
...
""))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/blue_circle.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SelectIcon.addItem(icon, _fromUtf8(""))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/green_circle.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SelectIcon.addItem(icon1, _fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/red_circle.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SelectIcon.addItem(icon2, _fromUtf8(""))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/yellow_circle.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
" }"))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/firefox_logo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addlink.setIcon(icon4)
...
" }"))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/gimp.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addimage.setIcon(icon5)
...
" }"))
    ...
    def retranslateUi(self, KmlDialog):
        KmlDialog.setWindowTitle(_translate("KmlDialog", "Dialog", None))
        self.KmlGeneralgroupBox.setTitle(_translate("KmlDialog", "General", None))
        self.label.setText(_translate("KmlDialog", "Name", None))
        self.label_2.setText(_translate("KmlDialog", "Label", None))
        self.Iconlabel.setText(_translate("KmlDialog", "Icon", None))
        self.SelectIcon.setItemText(1, _translate("KmlDialog", "blue_circle", None))
        self.SelectIcon.setItemText(2, _translate("KmlDialog", "green_circle", None))
        self.SelectIcon.setItemText(3, _translate("KmlDialog", "red_circle", None))
        self.SelectIcon.setItemText(4, _translate("KmlDialog", "yellow_circle", None))
        ...
        self.groupBox.setTitle(_translate("KmlDialog", "Position", None))
        self.groupBox_2.setTitle(_translate("KmlDialog", "Description", None))
